...
The entered password is hashed with SHA1. The first five chars of the hash are sent to the API which returns the hashes of all the passwords whose first five chars match, along with a count of how many occurrences of that password are in the database. (The returned hashes are missing
